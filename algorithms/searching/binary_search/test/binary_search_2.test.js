...
const binarysearch = require('../src/binary_search_2');
...
test('Searches array for provided value', () => {
  expect(binarysearch(88, sSorted)).toBe(88);
  expect(binarysearch(17, lSorted)).toBe(17);
});

test('Returns -1 if value does not exist in array', () => {
  expect(binarysearch(-17, lSorted)).toBe(-1);
});
