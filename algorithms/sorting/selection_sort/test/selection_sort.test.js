...
const selectionsort = require('../src/selection_sort');
...
describe('selectionsort', function(){
  test('Takes an array and sorts it in place', function(){
    expect(selectionsort([88, 74, 78, 45, 23, 1, 10, 8, 100])).to.deep.equal([1, 8, 10, 23, 45, 74, 78, 88, 100]);
    expect(selectionsort(lr)).to.deep.equal(lrSorted);
  });
});
