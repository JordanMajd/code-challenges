...
const quicksort = require('../src/quick_sort');
...
describe('quicksort', function(){
  test('Takes an array and sorts it in place', function(){
    expect(quicksort([88, 74, 78, 45, 23, 1, 10, 8, 100])).to.deep.equal([1, 8, 10, 23, 45, 74, 78, 88, 100]);
    expect(quicksort(lr)).to.deep.equal(lrSorted);
  });
});
