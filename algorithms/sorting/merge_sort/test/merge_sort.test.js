...
const mergeSortRecursive = require('../src/merge_sort_recursive');
...
fdescribe('mergeSortRecursive', function(){
  it('Takes an array and sorts it in place', function(){
    expect(mergeSortRecursive([88, 74, 78, 45, 23, 1, 10, 8, 100])).to.deep.equal([1, 8, 10, 23, 45, 74, 78, 88, 100]);
    expect(mergeSortRecursive(lr)).to.deep.equal(lrSorted);
  });
});
